...
| Form Factor               | Build             | CPU Slots | Memory Slots | Chipsets                                    | BIOS   | PCI Slots | SATA Slots |
| ------------------------- | ----------------- | --------- | ------------ | ------------------------------------------- | ------ | --------- | ---------- |
| AT Motherboard            | 305mm x 280mm     | 1         | 2-4          | Older chipsets either from Intel, AMD, etc. | Legacy | 3-5       | 2          |
| ATX Motherboard           | 305mm x 244mm     | 1         | 4-8          | Chipsets either from Intel, AMD, etc.       | UEFI   | 6-8       | 4-6        |
| BTX Motherboard           | 264mm x 267mm     | 1         | 4            | BTX-specific Intel Chipsets                 | UEFI   | 7         | 2-4        |
| Extended-ATX Motherboard  | 304.8mm x 330.2mm | 1-2       | 8-16         | Chipsets either from Intel, AMD, etc.       | UEFI   | 6-8       | 6-8        |
| LPX Motherboard           | 228.6mm x 330.2mm | 1         | 2-4          | Chipsets either from Intel, AMD, etc.       | N/A    | 1-2       | 4-6        |
| Micro-ATX Motherboard     | 244m x 244m       | 1         | 4            | Chipsets either from Intel, AMD, etc.       | UEFI   | 2         | 4          |
| Mini ITX Motherboard      | 170mm x 170mm     | 1         | 2            | Chipsets either from Intel, AMD, etc.       | UEFI   | 1         | 2          |
| Mini-ATX Motherboard      | 284mm x 208mm     | 1         | 22-4         | N/A                                         | N/A    | 2         | 4          |
| Pico BTX Motherboard      | 203mm x 267mm     | 1         | 2            | BTX-specific Intel Chipsets                 | UEFI   | 1-2       | 1          |
| Standard- ATX Motherboard | 305mm x 244mm     | 1         | 4-8          | Chipsets either from Intel, AMD, etc.       | UEFI   | 6-8       | 4-6        |

### Builtin Features

| Form Factor               | Builtin Features                                                                              |
| ------------------------- | --------------------------------------------------------------------------------------------- |
| AT Motherboard            | - Simpler, having fewer connectors and ports, Memory Slots are next to the processor          |
| ATX Motherboard           | - Works well with newer and high-end processors, Expansibility and Upgradability              |
| BTX Motherboard           | - designed to decrease power needs and reduce heat                                            |
| Extended-ATX Motherboard  | - Extra space for optimal airflow and cooling, Supports multi-GPU setups, Higher Ram Capacity |
| LPX Motherboard           | - Expansion cards are installed via a riser card to save vertical space                       |
| Micro-ATX Motherboard     | - Compact form factor but very capable                                                        |
| Mini ITX Motherboard      | - Low Power Consumption, great for energy-efficient computers                                 |
| Mini-ATX Motherboard      | - Compact form factor but very capable                                                        |
| Pico BTX Motherboard      | - Efficient Thermal Design, Compact Design                                                    |
| Standard- ATX Motherboard | - Works well with newer and high-end processors, Expansibility and Upgradability              |
