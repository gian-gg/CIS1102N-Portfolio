...
| Types of Computers  | Name/Brand               | Build                       | CPU                                                             | Memory                                           | Processing Speed                                        |
| ------------------- | ------------------------ | --------------------------- | --------------------------------------------------------------- | ------------------------------------------------ | ------------------------------------------------------- |
| Super Computers     | Fugaku (RIKEN & FUJITSU) | Room-Scale                  | 48-cores Armv8.2-A SVE 512 bit                                  | 4.85 PB, HBM2 32 GiB, 1024 GB/s                  | 48-cores, 2.0/2.2 GHz                                   |
| Mainframe Computers | IBM z16                  | 60” x 24” x 48” x per frame | Up to 200 cores, ~22.5 Bullion Transistors, IBM Telum Processor | 40TB DDR4                                        | Up to 200 cores, Up to 5.2GHz                           |
| Mini Computers      | Apple Mac Mini M4        | 5cm x 12.7cm x 12.7 cm      | Up to 12-core CPU, Apple Silicon M4                             | Up to 24GB of unified memory                     | Up to 8 Performance Cores and Up to 6 Efficiency Cores  |
| Server              | Dell PowerEdge R740      | 3.4” x 17.08” x 29.03”      | Up to two 2nd Generation Intel Xeon Scalable processor          | 24 DDR4 DIMM slots (3TB), Supports RDIMM /LRDIMM | Up to 28 cores per processor, up to 3.8GHz              |
| Workstations        | Apple Mac Studio M2      | 9.5cm x 19.7cm x 19.7cm     | Up to 24-core CPU, Apple Silicon M2 Ultra                       | Up to 192GB of unified memory                    | Up to 16 Performance Cores and Up to 8 Efficiency Cores |
| Micro Computers     | Apple MacBook Air M1     | 1.61cm x 30.41cm x 21.24cm  | Up to 8-core CPU, Apple Silicon M1                              | Up to 16GB of unified memory                     | Up to 4 Performance Cores and Up to 4 Efficiency Cores  |

| Calculating Principle | Working Principle                                                                                                                                         | Energy Consumption  |
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| > 488 Petaflops       | Processes massive data in parallel using multiple processors and nodes interconnected for high-speed communication.                                       | ~30 MW              |
| > 200 teraflops       | Processes information using advanced multi-core architecture.                                                                                             | 20-30 KW per system |
| ~5 teraflops          | It features up to 8 performance cores and 4 efficiency cores, and it is designed for handling more demanding applications and multitasking.               | 40 watts            |
| N/A                   | Utilizes multi-core processors that execute multiple threads simultaneously and are optimized by caching and memory bandwidth.                            | 300 - 1200 watts    |
| Up to 20.8 teraflops  | Utilizing its System-on-a-Chip design, integrating a powerful CPU, GPU, Neural Engine, and Unified Memory to efficiently handle tasks                     | 300 - 1200 watts    |
| Up to 2.6 teraflops   | Uses a system-on-a-chip architecture, meaning that the CPU, GPU, RAM, and other components are integrated into a single chip, making it highly efficient. | 30 watts            |

| **Super Computer**: Fugaku                                                                                                                                                                                                   |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![fugaku](../portfolio_assets/6/fugaku.jpeg)                                                                                                                                                                                 |
| A supercomputer developed by RIKEN and FUJITSU inJapan. It is designed for high-performance computing tasks and is known for its remarkable computational power. Recognized to be the world’s fast supercomputer since 2022. |
| **Usage**: Medical and Drug Research, Environmental and Disaster Protection, Scientific and Technological Research.                                                                                                          |

| **Mainframe Computer**: IBM z16                                                                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![z16](../portfolio_assets/6/z16.jpeg)                                                                                                                      |
| A mainframe computer designed and developed by IBM. Optimized for enterprise workloads, providing reliability, security, and scalability for organizations. |
| **Usage**: Banking, Finance, Healthcare, Fraud Detection and Data Analytics.                                                                                |

| **Mini Computer**: Apple Mac Mini M4                                                                                                          |
| --------------------------------------------------------------------------------------------------------------------------------------------- |
| ![m4mini](../portfolio_assets/6/m4mini.jpeg)                                                                                                  |
| A powerful mini computer by Apple. This model provides significant performance despite its size which features a high-performing CPU and GPU. |
| **Usage**: General Computing, Work, and Personal Use                                                                                          |

| **Server**: Dell PowerEdge R740                                                                                                                                                                                                       |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![r740](../portfolio_assets/6/r740.jpeg)                                                                                                                                                                                              |
| A rack server developed by Dell. Designed for high-performance computing and enterprise environments. It is known for its scalability, reliability, and efficiency, offering businesses a versatile solution for demanding workloads. |
| **Usage**: Hosting virtual machines, Database management, training/running AI and Machine Learning.                                                                                                                                   |

| **Workstations**: Apple Mac Studio M2 Ultra                                                                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![m2ultra](../portfolio_assets/6/m2ultra.jpeg)                                                                                                                                                                                              |
| A high-performing workstation computer developed by Apple. Powered by the M2 Ultra chip, it is optimized for professional users, and offers exceptional processing power, energy efficiency, and advanced capabilities for demanding tasks. |
| **Usage**: Video and Photo Production, 3D Modeling and Animation, Software Development, Machine Learning, and AI, Research, and Simulations.                                                                                                |

| **Micro Computers**: Apple MacBook Air M1                                                                                                                                                                                                                 |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![m1air](../portfolio_assets/6/m1air.jpeg)                                                                                                                                                                                                                |
| A portable computer (laptop) designed by Apple. The first computers that included a System-On-A-Chip Architecture which offers significant improvements in performance and battery life. Ideal for everyday tasks, productivity, and light creative work. |
| **Usage**: General Computing, Work, and Personal Use                                                                                                                                                                                                      |
