...
| Name/Brand               | Calculating Principle | Working Principle                                                                                                                                         | Energy Consumption  |
| ------------------------ | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| Fugaku (RIKEN & FUJITSU) | > 488 Petaflops       | Processes massive data in parallel using multiple processors and nodes interconnected for high-speed communication.                                       | ~30 MW              |
| IBM z16                  | > 200 teraflops       | Processes information using advanced multi-core architecture.                                                                                             | 20-30 KW per system |
| Apple Mac Mini M4        | ~5 teraflops          | It features up to 8 performance cores and 4 efficiency cores, and it is designed for handling more demanding applications and multitasking.               | 40 watts            |
| Dell PowerEdge R740      | N/A                   | Utilizes multi-core processors that execute multiple threads simultaneously and are optimized by caching and memory bandwidth.                            | 300 - 1200 watts    |
| Apple Mac Studio M2      | Up to 20.8 teraflops  | Utilizing its System-on-a-Chip design, integrating a powerful CPU, GPU, Neural Engine, and Unified Memory to efficiently handle tasks                     | 300 - 1200 watts    |
| Apple MacBook Air M1     | Up to 2.6 teraflops   | Uses a system-on-a-chip architecture, meaning that the CPU, GPU, RAM, and other components are integrated into a single chip, making it highly efficient. | 30 watts            |
